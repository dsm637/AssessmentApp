...
{
    public sealed class FakeNpsClient : INpsApiClient
    {
        private const string ParksJsonResponse = @"{
  ""total"": ""18"",
  ""limit"": ""50"",
  ""start"": ""0"",
  ""data"": [
    ...
    },
    {
      ...
      ""relevanceScore"": 1
        ...
        public Task<HttpResponseMessage> GetParks(string stateCode, CancellationToken cancellationToken)
        {
            var jsonContent = new StringContent(ParksJsonResponse);
